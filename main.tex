...
% Logo principal
{\vspace{-3cm}\includegraphics[ width=.65\textwidth]{assets/SINC_LOGO.png}
}
...
% ------------------------------------------------------------
% Descomentar cuando se disponga de la lista de asistentes
% que no presentan una contribución.
% ------------------------------------------------------------
%
% \section*{Otros participantes}
%
% \small
% \begin{description}[style=multiline,leftmargin=4.3cm,
%                     font=\normalfont\bfseries]
%
% \item[Nombre y apellidos]
% Afiliación institucional.\\
% \href{mailto:correo@institucion.es}{correo@institucion.es}
%
% \end{description}
% \normalsize
